...
class PurchaseController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_purchase_show', array('id' => $purchase->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_purchase_show")
     * @Method("GET")
     */
    ...
    public function editAction(Request $request, Purchase $purchase)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_purchase_edit', array('id' => $purchase->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_purchase_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Purchase $purchase)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_purchase_delete', array('id' => $purchase->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
